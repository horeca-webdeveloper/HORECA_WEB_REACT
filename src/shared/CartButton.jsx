      ...
      {!icon ? (
        <button
          className={`${
            classes
              ? classes
              : "text-[#F9FAFC] bg-primary p-[2px] sm:px-4 sm:py-2 text-[12px]  rounded-md max-w-32 mx-auto font-normal  sm:font-semibold"
          }`}
        ...
        <button
          className={`${
            classes
              ? classes
              : "flex items-center justify-center bg-[#DEF9EC] text-[12px] p-[2px] sm:p-[10px] w-full sm:px-[1px] sm:px-4 rounded-[4px] ml-2 mt-2 group-hover:bg-primary transition-all duration-500"
          } `}
