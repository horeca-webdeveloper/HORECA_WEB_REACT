...
export const ReviewSection = ({ id }) => {
  ...
  useEffect(() => {
    setReviewsLoader(true);
    fetchProductReviews();
  }, [AllStar, TopReviews,updateReview]);
    ...
    <React.Fragment>
      {reviewsData ? (
        <div className="grid grid-cols-12 gap-4">
          ...
          {showPopup? <ReviewPopup setShowPopup={setShowPopup} popupHeading="Add Review" setUpdateReview={setUpdateReview} updateReview={updateReview} id={id}/>:''}
