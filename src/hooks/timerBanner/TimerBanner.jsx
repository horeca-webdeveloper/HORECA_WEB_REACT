        ...
        <Wrapper>
            <div className="flex items-center gap-4">
                <div className="relative basis-1/2 rounded-lg mt-8 ">
                    <img src={process.env.PUBLIC_URL + "/images/blog/timerBanner/1.jpg"} alt="" className="rounded-lg" />
                    <div className="flex items-center justify-between">
                        <div className="text-base text-gray-700 absolute font-semibold top-[58%] left-10">Remaining Time</div>
                        <div className="rounded-[4px] border border-gray-300 mt-1 bg-white px-5 py-1 font-semibold min-w-[150px] text-center absolute top-[65%] left-10">
                ...
                <div className="relative basis-1/2 rounded-lg mt-8 ">
                    <img src={process.env.PUBLIC_URL + "/images/blog/timerBanner/2.jpg"} alt="" className="rounded-lg" />
                    <div className="flex items-center justify-between">
                        <div className="text-base text-gray-700 absolute font-semibold top-[58%] left-10">Remaining Time</div>
                        <div className="rounded-[4px] border border-gray-300 mt-1 bg-white  px-5 py-1 font-semibold min-w-[150px] text-center absolute top-[65%] left-10">
                            <span className="text-gray-700 text-lg mx-2">{String(timeLeft.days).padStart(2, '0')}</span>
