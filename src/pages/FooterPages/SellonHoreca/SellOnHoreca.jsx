    ...
    <>
      ...
      <div className="flex mt-[10px] text-[32px] font-bold text-white h-[450px] w-full bg-gray-400">
        ...
        <div className="relative p-20 w-[100%]">
          <p className="text-[35px] ml-[3%] sm:text-[54px] leading:[10px] sm:leading-[63.34px] w-[50vw] sm:w-[478px]">
      ...
      <Wrapper>
        <div className="flex flex-col items-center justify-center text-center mt-[60px]">
          <h1 className="text-[30px] font-semibold leading-[35px] text-center">
            Discover our programs designed to help you scale
          </h1>
          <p className="text-[16px] font-normal mt-[20px] mb-[20px] leading-[30px] text-[#64748B] w-[60%] text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-[30px] p-[15px]">
          <div className=" rounded">
            <div>
              <img
                className="hidden sm:block object-cover w-[520px] h-[200px] sm:h-[280px] rounded"
          ...
          <div className=" h-[100%] rounded">
            <div>
              <img
                className="hidden sm:block object-cover w-[527px] h-[200px] sm:h-[280px] rounded"
                src="https://images.pexels.com/photos/29497729/pexels-photo-29497729/free-photo-of-iconic-view-of-burj-khalifa-in-dubai-skyline.jpeg?auto=compress&cs=tinysrgb&w=800"
              />
            </div>
            <div className="py-5">
          ...
          <div className=" h-[100%] rounded">
            <div>
              <img
                className="hidden sm:block object-cover w-[527px] h-[280px] rounded"
        ...
        <div className="flex flex-col items-center justify-center mb-[40px] text-center mt-[60px]">
          ...
          <p className="text-[16px] font-normal mt-[20px] leading-[30px] text-[#64748B] w-[60%] text-center">
            At HorecaStore, you can sell a wide range of products tailored for
            the hospitality industry, from kitchen equipment to dining
            essentials. Explore our platform to list everything from
            high-quality Products!
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-[30px] p-[15px]">
          <div className=" rounded">
            <div>
              <img
                className="hidden sm:block object-cover w-[383px] h-[200px] sm:h-[383px] rounded"
                src="https://images.pexels.com/photos/29497729/pexels-photo-29497729/free-photo-of-iconic-view-of-burj-khalifa-in-dubai-skyline.jpeg?auto=compress&cs=tinysrgb&w=800"
              />
            </div>
            <div className="py-5">
              <p className="text-[24px] text-center text-[#186737] font-normal leading-[30px]">
        ...
        <div className="flex flex-col items-center justify-center text-center mt-[60px]">
          ...
          <p className="text-[16px] font-normal mt-[10px] mb-[40px] leading-[30px] text-[#64748B] w-[60%] text-center">
            At HorecaStore, you can sell a wide range of products tailored for
            the hospitality industry, from kitchen equipment to dining
            essentials. Explore our platform to list everything from
            high-quality Products!
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-[30px] p-[15px]">
          <div className=" rounded">
            <div>
              <img
                className="hidden sm:block object-cover w-[383px] h-[200px] sm:h-[580px] rounded-md"
                src="https://images.pexels.com/photos/29497729/pexels-photo-29497729/free-photo-of-iconic-view-of-burj-khalifa-in-dubai-skyline.jpeg?auto=compress&cs=tinysrgb&w=800"
              />
            </div>
            <div className="py-5">
        ...
        <div className="flex flex-col items-center justify-center text-center mt-[60px]">
          ...
          <p className="text-[16px] font-normal mt-[20px] mb-[30px] leading-[30px] text-[#64748B] w-[60%] text-center">
            At HorecaStore, you can sell a wide range of products tailored for
            the hospitality industry, from kitchen equipment to dining
            essentials. Explore our platform to list everything from
            high-quality Products!
