...
const Career = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center mt-[10px] justify-center font-bold text-white h-[740px] w-full bg-gray-400">
        <img
          className="absolute h-[740px] w-full object-cover opacity-[0.5]"
          src="https://images.pexels.com/photos/7689734/pexels-photo-7689734.jpeg?auto=compress&cs=tinysrgb&w=800"
        />
        <div className="relative mt-[20%]">
          <form className="flex items-center w-[50vw] h-14 overflow-hidden bg-[white] p-[5px] rounded-full">
            <input
              type="text"
      ...
      <Wrapper>
        <div className="flex flex-col items-center justify-center text-center mt-[40px] ">
          ...
          <div className=" w-[70%]">
            <p className="text-[15px] leading-[32px] font-normal text-[#666666]">
        ...
        <div className="flex flex-col  sm:flex-row items-center p-5 py-10 justify-between">
          <div className="flex flex-col items-center justify-center">
            <img
              src={process.env.PUBLIC_URL + "/images/Mask_group.png"}
              alt=""
            />
            <p className="text-[18px] leading-[32px] mt-[10px] font-normal">
              Receive Application{" "}
            </p>
            <p className="text-[18px] leading-[32px] font-normal">
        ...
        <div className="mb-[100px]">
          <img src={process.env.PUBLIC_URL + "/images/Beware.png"} />
        </div>
        <div className=" mb-[-80px]">
          <h1 className="font-bold text-center leading-[35.19px] text-[30px]">
            Horeca Store Around The Globe
          </h1>
          <div className="grid grid-cols-1 ml-[4%] sm:ml-[0%] sm:grid-cols-3 gap-4 mb-[100px]">
        ...
        <div className="py-10 ">
          <h1 className="text-[45px] text-center sm:text-start leading-[52.79px] font-semibold">
            We are lifelong learners
          </h1>
          <p className=" text-[16px] text-center sm:text-start leading-[32px] font-light">
        ...
        <div>
          <div className="flex mt-[10px] mb-[20px] w-[98%] sm:w-[100%]">
            <img
              className="mr-[20px] object-cover h-[439px] w-[60%] rounded"
              src="https://images.pexels.com/photos/7551442/pexels-photo-7551442.jpeg?auto=compress&cs=tinysrgb&w=800"
            />
            <img
              className=" object-cover h-[439px] w-[40%] rounded"
              src="https://images.pexels.com/photos/7689734/pexels-photo-7689734.jpeg?auto=compress&cs=tinysrgb&w=800"
            />
          </div>
          <div className="flex  w-[98%] sm:w-[100%]">
            <img
              className="mr-[20px] object-cover h-[439px] w-[40%] rounded"
              src="https://images.pexels.com/photos/7689734/pexels-photo-7689734.jpeg?auto=compress&cs=tinysrgb&w=800"
            />
            <img
              className=" object-cover h-[439px] w-[60%] rounded"
              src="https://images.pexels.com/photos/7551442/pexels-photo-7551442.jpeg?auto=compress&cs=tinysrgb&w=800"
            />
          </div>
        </div>
        ...
        <div>
          <div className="flex mb-[20px] w-[98%] sm:w-[100%]">
            <img
              className=" object-cover mr-[20px] h-[439px] w-[60%] rounded"
          ...
          <div className="flex w-[98%] sm:w-[100%]">
            <img
              className=" object-cover mr-[20px] h-[439px] w-[40%] rounded"
              src="https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=800"
            />
            <img
              className=" object-cover h-[439px] w-[60%] rounded"
