...
import { collectionCategories, BrandPicks, ListofProducts } from "../data/Collections";
...
export const CollectionInnerPage = () => {
    const colors = [
        ...
        "#FFEE33", "#FF9933", "#A833FF", "#33A1FF", "#FF3381",
        "#FF3333", "#33FF99", "#3333FF", "#FF33D1", "#33FFD5",
        "#FF7F50", "#FFD700", "#4B0082", "#7FFF00", "#DC143C",
        "#8B008B", "#B8860B", "#FF4500", "#2E8B57", "#4682B4",
        "#DA70D6", "#6B8E23", "#FF69B4", "#CD5C5C", "#FFA500",
        "#8A2BE2", "#A52A2A", "#5F9EA0", "#D2691E", "#FF1493",
        "#00FF7F", "#ADFF2F", "#800000", "#808000", "#00CED1",
        "#40E0D0", "#EE82EE", "#B22222", "#228B22",
    ]
    ...
    return (
        <div>
            ...
            <Wrapper>
                <div className="grid grid-cols-9 gap-4">
                    <div className="col-span-2 h-[100vh] overflow-auto pr-3 mt-8">
                        ...
                        <React.Fragment>
                            ...
                            <div className="relative mt-1">
                                <CiSearch size={"18px"} color="#707070" className="absolute top-3 left-3" />
                                <input className="w-full border border-gray-300  rounded-full py-2 pl-10 pr-6 outline-none" placeholder="Find a brand..." type="text" />

                                <div className="mt-3">
                                    <CustomCheckbox id={1} title="Brand Name Here" quantity="25" />
                                    <CustomCheckbox id={2} title="Brand Name Here" quantity="25" />
                                    <CustomCheckbox id={3} title="Brand Name Here" quantity="25" />
                                    <CustomCheckbox id={4} title="Brand Name Here" quantity="25" />
                                    <CustomCheckbox id={5} title="Brand Name Here" quantity="25" />
                        ...
                        <React.Fragment>
                            ...
                            <div className="mt-3">
                                <CustomCheckbox id={1} title="0.9 to 1.3 Cu. Ft.’’" quantity="25" />
                                <CustomCheckbox id={2} title="Less than 0.9 Cu. Ft.’’" quantity="25" />
                                <p className="underline text-gray-700 text-xs mt-2">See More</p>
                            </div>
                            <div className="w-full h-[1px] bg-[#E2E8F0] mt-4 mb-3"></div>
                        </React.Fragment>
                        ...
                        <React.Fragment>
                            ...
                            <div className="mt-3">
                                <CustomCheckbox id={1} title="Automatic Defrost" quantity="25" />
                                <CustomCheckbox id={2} title="One Touch Cooking" quantity="25" />
                                <CustomCheckbox id={3} title="Programmed Cooking Mode" quantity="25" />
                            ...
                            <div className="mt-3">
                                <div className="flex items-center flex-wrap gap-4 gap-y-5">
                                    {colors.map((col, index) => {
                                        return (
                                            <span key={index} className={`size-4 rounded-full cursor-pointer`} style={{ backgroundColor: col }}></span>
                                        )
                                    })}
                                </div>
                            </div>
                    ...
                    <div className="col-span-7 mt-8">
                        <h2 className="font-semibold text-lg text-black-100">Cooking Equipments</h2>
                        <div className="w-full h-[1px] bg-[#E2E8F0] my-5"></div>

                        <div className="flex flex-row items-center justify-between">
                            <span className="text-sm text-gray-700">Showing all 51606 results</span>
                            <div className="flex flex-row items-center ">
                                <span className="text-sm text-gray-700 mr-6">
                                    Sort:
                                    <span className="text-black-100 ml-1 relative">
                                        <Menu arrow={true} className={"top-0"} menuButton={<button type="button">Default Sorting</button>}>
                                ...
                                <span className="text-sm text-gray-700 mr-6">Show:
                                    <span className="text-black-100 ml-1 relative">
                                        <Menu className={"top-0"} arrow={true} align="center" top="0px" menuButton={<button type="button">80 Items</button>}>
                        ...
                        <div className="grid grid-cols-6 gap-5 mt-8">
                            {collectionCategories.map((cat, index) => {
                                return (
                                    <Link to={cat.url} key={index} className="col-span-1 flex items-center justify-center flex-col">
                                        <img src={cat.imgSrc} alt="" />
                                        <h4 className="mt-2 text-base font-semibold text-primary">{cat.title}</h4>
                                    </Link>
                                )
                            })}
                        </div>
            ...
            <div className="w-full">
                <img src={process.env.PUBLIC_URL + "/images/collections/full-width-short-banner.png"} alt="" />
            </div>
