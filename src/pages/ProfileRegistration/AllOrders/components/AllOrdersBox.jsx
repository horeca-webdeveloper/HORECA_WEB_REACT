      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="border-none sm:border-r-2 sm:border-solid h-[55px] p-[0px] sm:p-[10px] ml-[10px] mr-[10px]">
            <span className="hidden sm:block font-sans text-center text-base font-normal leading-6 text-left text-[#666666] decoration-clone">
              Created date
            </span>
            <p className="font-sans text-[12px] sm:mt-[0px] sm:text-base font-normal leading-6 text-left text[#030303] decoration-slice">
              {data?.updated_at.split("T")[0]}
            </p>
            <p className="block sm:hidden font-sans text-[12px] sm:text-base font-normal leading-6 text-left text[#030303] decoration-slice">
              {data?.code}
            </p>
          </div>
          <div className="hidden sm:block border-r-2 h-[55px] p-[10px] ml-[10px] mr-[10px]">
          ...
          <div className="hidden sm:block border-r-2 h-[55px] text-center p-[10px] ml-[10px] mr-[10px]">
            <span className="font-sans text-center text-base font-normal leading-6 text-left text-[#666666] decoration-clone">
              Order status
            </span>
            <p className="font-sans text-base font-normal leading-6 text-left text[#030303] decoration-slice">
        ...
        <div className="flex flex-col p-[15px] ">
          <p className="hidden sm:block font-sans mb-[4px] text-base text-right font-light leading-[24px] text-left text-[#666666] decoration-0">
            Order Total
          </p>
          <p className="block sm:hidden font-sans text-[12px] bg-[#E2E8F0] px-[10px] rounded-full text-black text-right font-light leading-[24px] text-left text-[#666666] decoration-0">
            In Progress
          </p>
          <p className="flex font-sans text-[13px] sm:text-[14px] font-normal leading-[24px] text-left text-[#666666] decoration-0">
            AED{" "}
            <span className="hidden sm:block font-sans text-[22px] font-semibold leading-[24px] text-left text-[black] decoration-0">
              {data?.amount.split(".")[0]}
            </span>
            <span className="block sm:hidden ml-[5px] font-sans text-[13px] font-semibold leading-[24px] text-left text-[black] decoration-0">
              {data?.amount.split(".")[0]}
            </span>
            .{data?.amount.split(".")[1]}
          </p>
